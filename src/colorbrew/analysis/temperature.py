...
def kelvin_to_rgb(kelvin: int) -> tuple[int, int, int]:
    """Approximate an sRGB color from a color temperature in Kelvin.

    Uses the common Tanner Helland black-body approximation for 1000K-40000K.
    ...
    if temp <= 66:
        red = 255
        green = 99.4708025861 * __import__("math").log(temp) - 161.1195681661
    else:
    ...
    if temp >= 66:
        ...
        blue = 138.5177312231 * __import__("math").log(temp - 10) - 305.0447927307
