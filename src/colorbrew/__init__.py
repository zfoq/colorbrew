...
Provides color parsing, format conversion, palette generation, accessibility
checking, CSS/HTML output, reverse name lookup, blending modes, and color
temperature classification through a single ``Color`` class.
"""
